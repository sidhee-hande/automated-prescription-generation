 ...
 <div id="app" class="container">
  <h1 > PRESCRIPTION  </h1>
    ...
    <div class="col">
      ...
      <div class="col">
      <b-form-input
      type="text" v-if="items.edit" v-model="items.name"
  ...
  <div class="row">
    ...
    <div class="col">
     ...
     <div class="col">
    <b-form-input
    type="text" v-if="items.edit" v-model="items.age"></b-form-input>
    </div>
    </div>
...
<div class="row">
 ...
 <div class="row">
    <div class="col">
     ...
     <div class="col">
     <b-form-input
    type="text" v-if="items.edit" v-model="items.symptoms"></b-form-input>
</div>
</div>
</div>
</div>
...
<div class="row">
 ...
 <div class="row">
    <div class="col">
     ...
     <div class="col">
    <b-form-input
    type="text"  v-if="items.edit" v-model="items.diagnosis"> </b-form-input>
    </div>
    </div>
    </div>
    </div>
...
<div class="row">
 ...
 <div class="row">
    ...
    <div class="col">
    <b-form-input
    type="text" v-if="items.edit" v-model="items.medicines"></b-form-input>
  </div>
  </div>
</div>
</div>
 ...
 <div class="row">
    ...
    <div class="col">
     <b-form-input
    type="text" v-if="items.edit" v-model="items.dosageofmedication"></b-form-input>

     <b-form-input
    type="text" v-if="items.edit" v-model="items.frequencyofmedication"></b-form-input>
    </div>
    </div>
    </div>
    </div>
